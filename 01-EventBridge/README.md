...
1. No terminal do IDE criado no cloud9 execute o comando `cd ~/environment/senai-gerencia-de-configuracao/01-EventBridge/` para entrar na pasta que fara este exercicio.
